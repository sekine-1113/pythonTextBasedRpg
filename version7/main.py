...
class RPG_CALL_ONCE(Singleton):
    ...
    def insert_class_master(self):
        with open(r"version7\data\classes_master.csv", "r", encoding="UTF-8") as f:
    ...
    def insert_class_status_master(self):
        with open(r"version7\data\classes_status_master.csv", "r", encoding="UTF-8") as f:
    ...
    def make_class_ability_table(self):
        ...
        if self.insert:
            with open(r"version7\data\classes_abilities_master.csv", "r", encoding="UTF-8") as f:
                data = [row for row in csv.reader(f)]
    ...
    def make_abilities_table(self):
        ...
        if self.insert:
            with open(r"version7\data\abilities_master.csv", "r", encoding="utf-8") as f:
    ...
    def make_enemies_table(self):
        self.cur.execute("""
                ...
                """)
        if self.insert:
            with open(r"version7\data\enemies_master.csv", "r", encoding="UTF-8") as f:
    ...
    def make_quests_table(self):
        ...
        if self.insert:
            with open(r"version7\data\quests_master.csv", "r", encoding="UTF-8") as f:
