...
class Input:
    ...
    def integer_within_range(self, prompt:str="> ", _min:int=0, _max:int=0) -> int:
        user_input = input(prompt)
        try:
            user_input = int(user_input)
    ...
    def integer_within_array(self, prompt:str="> ", _array:list=[]) -> int:
        user_input = input(prompt)
        try:
            user_input = int(user_input)
...
if __name__ == "__main__":
    ...
    user_input.integer_within_range("[1] OK [0] NG > ", 0, 1)
    user_input.integer_within_array("[1] OK [0] NG > ", [0, 1])
